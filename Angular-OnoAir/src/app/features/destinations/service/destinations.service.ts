...
export class DestinationService {
  private destinations: Destination[] = [
    new Destination(
      ...
      "info@ben-gurion.com",
      "TLV",
      "https://cdn.britannica.com/80/94380-050-F182700B/Tel-Aviv-Yafo-Israel.jpg"
    ),
    new Destination(
      "New York",
    ...
    new Destination(
      "Zurich",
      "Zurich Airport",
      "https://www.zurich-airport.com/en",
      "info@zurich-airport.com",
      "ZRH",
      "https://switzerland-tour.com/storage/media/Zurich/fraumunster-church-in-zurich.jpg"
    ),
    new Destination(
      "Larnaca",
      "Larnaca International Airport",
      "https://www.hermesairports.com",
      "info@larnaca-airport.com",
      "LCA",
      "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/a5/dd/08/caption.jpg"
    ),
    new Destination(
      "Paris",
